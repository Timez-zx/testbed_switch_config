...
def eth_trunk_spine_add():
    ...
    command.append('sy')
    command.append('int eth-trunk 10')
    command.append('trunkport 100GE1/0/31')
    command.append('q')
    command.append('commit')
    telnet_client = TelnetClient()
    if telnet_client.login_host(host_ip, username, password, 'N'):
...
def eth_trunk_leaf_add():
    ...
    command.append('sy')
    command.append('int eth-trunk 10')
    command.append('trunkport 100GE1/0/63')
    command.append('commit')
